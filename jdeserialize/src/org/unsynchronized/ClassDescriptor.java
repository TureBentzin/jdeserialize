 ...
 * </p>
 */
public class ClassDescriptor extends Content {
    /**
     ...
     */
    public List<ClassDescriptor> innerClasses;
     ...
     */
    public void addInnerClass(ClassDescriptor cd) {
        innerClasses.add(cd);
    }
     ...
     *
     * @param constant enum constant string
     */
    ...
    public String toString() {
        return "[cd " + JDeserialize.hex(handle) + ": name " + name +
                " uid " + uid +
                "]";
    }
    ...
    public void validate() throws ValidityException {
        ...
        if ((descriptorFlags & (ObjectStreamConstants.SC_SERIALIZABLE | ObjectStreamConstants.SC_EXTERNALIZABLE)) == 0 && fields != null && fields.length > 0) {
            throw new ValidityException("non-serializable, non-externalizable class has fields!");
        }
        if ((descriptorFlags & (ObjectStreamConstants.SC_SERIALIZABLE | ObjectStreamConstants.SC_EXTERNALIZABLE)) == (ObjectStreamConstants.SC_SERIALIZABLE | ObjectStreamConstants.SC_EXTERNALIZABLE)) {
            throw new ValidityException("both Serializable and Externalizable are set!");
        }
        if ((descriptorFlags & ObjectStreamConstants.SC_ENUM) != 0) {
